...
var pageData    = {
  data: {"classify1":{"type":"classify","style":"font-size:30.46875rpx;height:82.03125rpx;line-height:82.03125rpx;opacity:1;background-color:rgb(255, 255, 255);color:rgb(199, 204, 207);margin-top:0;margin-left:auto;","content":[{"customFeature":{"index_value":""},"text":"全部","content":"","parentCompid":"classify1","style":""},{"customFeature":{"index_value":"电商","action":"refresh-list","refresh_object":"list-759266807831","index_segment":"category"},"text":"电商","content":"","parentCompid":"classify1","style":"","itemType":null,"itemParentType":"classify","itemIndex":1,"eventParams":"{\"refresh_object\":\"list-759266807831\",\"index_segment\":\"category\",\"index_value\":\"\\u7535\\u5546\",\"comp_id\":null,\"parent_comp_id\":\"classify1\",\"item_index\":1,\"type\":null,\"parent_type\":\"classify\"}","eventHandler":"tapRefreshListHandler"},{"customFeature":{"index_value":"资讯","action":"refresh-list","refresh_object":"list-759266807831","index_segment":"category"},"text":"资讯","content":"","parentCompid":"classify1","style":"","itemType":null,"itemParentType":"classify","itemIndex":2,"eventParams":"{\"refresh_object\":\"list-759266807831\",\"index_segment\":\"category\",\"index_value\":\"\\u8d44\\u8baf\",\"comp_id\":null,\"parent_comp_id\":\"classify1\",\"item_index\":2,\"type\":null,\"parent_type\":\"classify\"}","eventHandler":"tapRefreshListHandler"},{"customFeature":{"index_value":"家装","action":"refresh-list","refresh_object":"list-759266807831","index_segment":"category"},"text":"家装","content":"","parentCompid":"classify1","style":"","itemType":null,"itemParentType":"classify","itemIndex":3,"eventParams":"{\"refresh_object\":\"list-759266807831\",\"index_segment\":\"category\",\"index_value\":\"\\u5bb6\\u88c5\",\"comp_id\":null,\"parent_comp_id\":\"classify1\",\"item_index\":3,\"type\":null,\"parent_type\":\"classify\"}","eventHandler":"tapRefreshListHandler"}],"customFeature":{"mode":"1","selected":"0","selectedColor":"rgb(51, 51, 51)"},"animations":[],"page_form":"","compId":"classify1"},"list_vessel2":{"type":"list-vessel","style":"margin-top:2.34375rpx;opacity:1;height:703.125rpx;background-color:rgb(243, 243, 243);margin-left:auto;","content":[{"type":"free-vessel","style":"width:750rpx;height:217.96875rpx;background-color:rgb(255, 255, 255);margin-bottom:auto;margin-right:auto;opacity:1;margin-left:auto;","content":[{"type":"picture","style":"opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:128.90625rpx;width:154.6875rpx;margin-left:auto;margin-right:0;margin-top:0;position:absolute;left:23.4375rpx;top:16.40625rpx;","content":"https:\/\/1251027630.cdn.myqcloud.com\/1251027630\/zhichi_frontend\/static\/webapp\/images\/default.png","customFeature":{"boxShadow":"5","boxColor":"#000","boxX":"0","boxY":"0","boxR":"5","segment":"logo","ifMust":false},"animations":[],"compId":"data.content[0]","parentCompid":"data.content[0]"},{"type":"text","style":"background-color:rgba(0, 0, 0, 0);border-color:rgb(34, 34, 34);border-style:none;border-width:4.6875rpx;color:rgb(51, 51, 51);font-size:28.125rpx;font-weight:bold;height:44.53125rpx;width:412.5rpx;line-height:44.53125rpx;margin-left:auto;margin-top:0;opacity:1;text-align:left;position:absolute;left:208.59375rpx;top:18.75rpx;margin-right:0;","content":"我是文本","customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":"5","boxStyle":false,"boxX":"0","boxY":"0","segment":"name","ifMust":false},"animations":[],"compId":"data.content[1]","parentCompid":"data.content[0]","markColor":"","mode":0},{"type":"text","style":"background-color:rgba(0, 0, 0, 0);border-color:rgb(34, 34, 34);border-style:none;border-width:4.6875rpx;color:rgb(163, 163, 163);font-size:23.4375rpx;height:44.53125rpx;width:503.90625rpx;line-height:44.53125rpx;margin-left:auto;margin-top:0;opacity:1;text-align:left;position:absolute;left:208.59375rpx;top:72.65625rpx;margin-right:0;","content":"我是文本","customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":"5","boxStyle":false,"boxX":"0","boxY":"0","segment":"details","ifMust":false},"animations":[],"compId":"data.content[2]","parentCompid":"data.content[0]","markColor":"","mode":0},{"type":"picture","style":"opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:42.1875rpx;width:75rpx;margin-left:auto;margin-right:0;margin-top:0;position:absolute;left:23.4375rpx;top:164.0625rpx;","content":"http:\/\/img.weiye.me\/zcimgdir\/album\/file_5938e7aea1863.png","customFeature":{"boxShadow":"5","boxColor":"#000","boxX":"0","boxY":"0","boxR":"5"},"animations":[],"compId":"data.content[3]","parentCompid":"data.content[0]"},{"type":"text","style":"background-color:rgba(0, 0, 0, 0);border-color:rgb(34, 34, 34);border-style:none;border-width:4.6875rpx;color:rgb(128, 128, 128);font-size:23.4375rpx;height:44.53125rpx;line-height:44.53125rpx;margin-left:auto;margin-top:0;opacity:1;text-align:left;position:absolute;left:37.5rpx;top:164.0625rpx;margin-right:0;","content":"我是","customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":"5","boxStyle":false,"boxX":"0","boxY":"0","segment":"tag1","ifMust":false},"animations":[],"compId":"data.content[4]","parentCompid":"data.content[0]","markColor":"","mode":0},{"type":"picture","style":"opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:42.1875rpx;width:75rpx;margin-left:auto;margin-right:0;margin-top:0;position:absolute;left:124.21875rpx;top:164.0625rpx;","content":"http:\/\/img.weiye.me\/zcimgdir\/album\/file_5938e7aea1863.png","customFeature":{"boxShadow":"5","boxColor":"#000","boxX":"0","boxY":"0","boxR":"5"},"animations":[],"compId":"data.content[5]","parentCompid":"data.content[0]"},{"type":"text","style":"background-color:rgba(0, 0, 0, 0);border-color:rgb(34, 34, 34);border-style:none;border-width:4.6875rpx;color:rgb(128, 128, 128);font-size:23.4375rpx;height:44.53125rpx;line-height:44.53125rpx;margin-left:auto;margin-top:0;opacity:1;text-align:left;position:absolute;left:140.625rpx;top:164.0625rpx;margin-right:0;","content":"我是","customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":"5","boxStyle":false,"boxX":"0","boxY":"0","segment":"tag2","ifMust":false},"animations":[],"compId":"data.content[6]","parentCompid":"data.content[0]","markColor":"","mode":0},{"type":"picture","style":"opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:56.25rpx;width:154.6875rpx;margin-left:auto;margin-right:0;margin-top:0;position:absolute;left:569.53125rpx;top:159.375rpx;","content":"http:\/\/img.weiye.me\/zcimgdir\/album\/file_5938e847564da.png","customFeature":{"boxShadow":"5","boxColor":"#000","boxX":"0","boxY":"0","boxR":"5"},"animations":[],"compId":"data.content[7]","parentCompid":"data.content[0]"},{"type":"text","style":"background-color:rgba(0, 0, 0, 0);border-color:rgb(34, 34, 34);border-style:none;border-width:4.6875rpx;color:rgb(77, 151, 239);font-size:28.125rpx;font-weight:bold;height:44.53125rpx;width:79.6875rpx;line-height:44.53125rpx;margin-left:auto;margin-top:0;opacity:1;text-align:left;position:absolute;left:616.40625rpx;top:166.40625rpx;margin-right:0;","content":"查 看","customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":"5","boxStyle":false,"boxX":"0","boxY":"0"},"animations":[],"compId":"data.content[8]","parentCompid":"data.content[0]","markColor":"","mode":0}],"customFeature":{"boxColor":"rgb(0, 0, 0)","boxR":5,"boxStyle":false,"boxX":0,"boxY":0,"action":"none","inner-page-link":"page10004"},"animations":[],"parentCompid":"list_vessel2","compId":"data.content[0]"}],"customFeature":{"background-color":"rgb(243, 243, 243)","background-image":"","form":"anli","id":"list-219763123900","lineBackgroundColor":"rgb(243, 243, 243)","lineBackgroundImage":"","link":"page10004","margin":"0","name":"列表","source":"none","vesselAutoheight":1,"mode":0,"height":"300px"},"animations":[],"page_form":"","compId":"list_vessel2","list_style":"background-color:rgb(243, 243, 243);margin-left:auto;","customFeature_id":"list-219763123900","is_more":1,"param":"{\"id\":\"list-219763123900\",\"form\":\"anli\",\"page\":1,\"app_id\":\"RCc6Rs6DlQ\",\"is_count\":0}","form":"anli"},"has_tabbar":0},
    need_login: false,
    page_router: 'page10005',
    page_form: 'none',
      list_compids_params: [{"compid":"list_vessel2","param":{"id":"list-219763123900","form":"anli","page":1,"app_id":"RCc6Rs6DlQ","is_count":0}}],
